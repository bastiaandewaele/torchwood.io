...
if (!fs.existsSync(bootstrap.src)) {
    ...
    fs.writeFileSync(bootstrap.src+"/sass/main.scss", fs.readFileSync(__dirname+"/../../samples/sass/main.scss"));
    fs.writeFileSync(bootstrap.src+"/js/main.js", fs.readFileSync(__dirname+"/../../samples/js/main.js"));

    // Concat
    fs.writeFileSync(bootstrap.src+"/concat/test.css", fs.readFileSync(__dirname+"/../../samples/concat/test.css"));
    fs.writeFileSync(bootstrap.src+"/concat/foo.css", fs.readFileSync(__dirname+"/../../samples/concat/foo.css"));
    fs.writeFileSync(bootstrap.src+"/concat/foo.js", fs.readFileSync(__dirname+"/../../samples/concat/foo.js"));
    fs.writeFileSync(bootstrap.src+"/concat/test.js", fs.readFileSync(__dirname+"/../../samples/concat/test.js"));
    fs.writeFileSync(bootstrap.src+"/templates/index.html", fs.readFileSync(__dirname+"/../../samples/templates/index.html"));
    fs.writeFileSync(bootstrap.src+"/templates/about.html", fs.readFileSync(__dirname+"/../../samples/templates/about.html"));
